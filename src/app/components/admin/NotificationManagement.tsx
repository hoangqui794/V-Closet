...
export function NotificationManagement() {
    ...
    const getTypeBadgeColor = (type: string) => {
        switch (type?.toLowerCase()) {
            case "system":
                return " dark:bg-muted/500/10 text-slate-500 border-slate-500/20";
            case "marketing":
                return " dark:bg-red-500/100/10 text-pink-500 border-pink-500/20";
            case "update":
                return " dark:bg-blue-500/100/10 text-blue-500 border-blue-500/20";
            case "alert":
                return " dark:bg-red-500/100/10 text-rose-500 border-rose-500/20";
            default:
                return " dark:bg-amber-500/100/10 text-amber-500 border-amber-500/20";
        }
    };
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 font-poppins text-foreground">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight text-[#4a3728] dark:text-foreground">Quản lý & Phát thông báo</h2>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                <TabsList className="bg-[#4a3728]/5 dark:bg-primary/5 border border-[#4a3728]/10 dark:border-primary/10 p-1 rounded-xl">
                    <TabsTrigger value="send" className="data-[state=active]:bg-[#4a3728] data-[state=active]:dark:bg-primary data-[state=active]:text-white data-[state=active]:dark:text-primary-foreground rounded-lg flex items-center gap-2">
                        <Send className="w-4 h-4" />
                        Gửi thông báo
                    </TabsTrigger>
                    <TabsTrigger value="logs" className="data-[state=active]:bg-[#4a3728] data-[state=active]:dark:bg-primary data-[state=active]:text-white data-[state=active]:dark:text-primary-foreground rounded-lg flex items-center gap-2">
                        <History className="w-4 h-4" />
                        Nhật ký thông báo
                    </TabsTrigger>
                    <TabsTrigger value="surveys" className="data-[state=active]:bg-[#4a3728] data-[state=active]:dark:bg-primary data-[state=active]:text-white data-[state=active]:dark:text-primary-foreground rounded-lg flex items-center gap-2">
                ...
                <TabsContent value="send" className="space-y-6">
                    <div className="grid gap-6 md:grid-cols-12 items-start">
                        ...
                        <div className="md:col-span-7 space-y-6">
                            <Card className="border-[#4a3728]/10 dark:border-primary/10 shadow-sm overflow-hidden bg-card/60 backdrop-blur-md">
                                <CardHeader className="bg-gradient-to-r from-[#4a3728]/5 to-[#4a3728]/0 border-b border-[#4a3728]/10 dark:border-primary/10">
                                    <CardTitle className="text-[#4a3728] dark:text-foreground flex items-center gap-2">
                                ...
                                <CardContent className="pt-6 space-y-4">
                                    <form onSubmit={handleSendSubmit} className="space-y-4">
                                                ...
                                                <button
                                                    ...
                                                    className={`flex items-center justify-center gap-2 p-3 rounded-xl border text-sm font-semibold transition-all duration-300
                                                        ${targetType === "broadcast"
                                                            ? "bg-[#4a3728] dark:bg-primary text-white dark:text-primary-foreground border-transparent shadow-md"
                                                            : "bg-card hover:bg-muted border-border/80 text-muted-foreground"}`}
                                                >
                                        ...
                                        {targetType === "targeted" && (
                                            <div className="space-y-2 p-4 bg-[#4a3728]/5 dark:bg-primary/5 border border-[#4a3728]/10 dark:border-primary/10 rounded-xl relative">
                                                ...
                                                {selectedUser ? (
                                                    <div className="flex items-center justify-between bg-card p-3 rounded-lg border  dark:border-green-500/20">
                                                        <div className="flex items-center gap-2.5">
                                                            <div className="w-8 h-8 rounded-full bg-[#4a3728] dark:bg-primary text-white dark:text-primary-foreground flex items-center justify-center font-bold text-sm shrink-0">
                                                                {selectedUser.displayName.slice(0, 2).toUpperCase()}
                                                            </div>
                                                            <div className="text-left">
                                                                <p className="text-sm font-semibold text-[#4a3728] dark:text-foreground">{selectedUser.displayName}</p>
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        />
                                                        {isSearchingUsers && (
                                                            <Loader2 className="absolute right-3 top-3 w-4 h-4 animate-spin text-[#4a3728] dark:text-foreground" />
                                                        )}

                                                        {/* Dropdown Results */}
                                                        {searchedUsers.length > 0 && (
                                                            <div className="absolute left-0 right-0 mt-1.5 bg-card border rounded-xl shadow-xl z-20 max-h-52 overflow-y-auto divide-y divide-border/60">
                                                                {searchedUsers.map(user => (
                                                                    <button
                                                                        key={user.userId}
                                                                        type="button"
                                                                        onClick={() => setSelectedUser(user)}
                                                                        className="w-full flex items-center gap-2.5 p-3 text-left hover:bg-[#4a3728]/5 dark:bg-primary/5 transition-colors duration-200"
                                                                    >
                                                                        <div className="w-7 h-7 rounded-full bg-[#4a3728]/10 dark:bg-primary/10 text-[#4a3728] dark:text-foreground flex items-center justify-center font-bold text-xs shrink-0">
                                                                            {user.displayName.slice(0, 2).toUpperCase()}
                                                                        </div>
                                                                        <div>
                                                                            <p className="text-xs font-semibold text-[#4a3728] dark:text-foreground">{user.displayName}</p>
                                                        ...
                                                        {userSearch.trim() && searchedUsers.length === 0 && !isSearchingUsers && (
                                                            <div className="absolute left-0 right-0 mt-1.5 bg-card border rounded-xl p-3 text-center text-xs text-muted-foreground shadow-xl z-20">
                                        ...
                                        <div className="space-y-2 pb-2">
                                            ...
                                            <div className="flex gap-6 items-center">
                                                <label className="flex items-center gap-2 text-sm  dark:text-muted-foreground cursor-pointer">
                                                    <input
                                                        type="checkbox"
                                                        checked={sendViaApp}
                                                        onChange={(e) => setSendViaApp(e.target.checked)}
                                                        className="w-4 h-4 rounded border-gray-300 text-[#4a3728] dark:text-foreground focus:ring-[#4a3728]"
                                                    />
                                                    Thông báo App (Push)
                                                </label>
                                                <label className="flex items-center gap-2 text-sm  dark:text-muted-foreground cursor-pointer">
                                        ...
                                        {/* Quick Templates */}
                                        <div className="space-y-1.5">
                                            <label className="text-xs font-semibold text-[#4a3728]/80 dark:text-foreground uppercase tracking-wide flex items-center justify-between">
                                            ...
                                            <select
                                                ...
                                                className="w-full flex h-10 rounded-xl border border-input bg-[#4a3728]/5 dark:bg-primary/5 px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                                            >
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <Input
                                                ...
                                                maxLength={100}
                                                required
                                                className="bg-card border-border font-medium text-foreground"
                                            />
                                        </div>
                                        ...
                                        <div className="pt-2">
                                            <Button
                                                type="submit"
                                                className="w-full bg-[#4a3728] dark:bg-primary hover:bg-[#3d2d21] dark:hover:bg-primary/90 text-white dark:text-primary-foreground flex items-center justify-center gap-2 h-11 rounded-xl font-semibold shadow-md transition-all duration-300"
                                            >
                                                <Send className="w-4 h-4" />
                                                Gửi thông báo ngay
                                            </Button>
                        ...
                        <div className="md:col-span-5 flex justify-center">
                            <div className="w-[300px] h-[580px] bg-slate-900 border-[8px] border-slate-800 rounded-[3rem] shadow-2xl relative overflow-hidden flex flex-col items-center">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-b from-[#6b5847] via-[#9c8470] to-[#bca693] z-0 flex flex-col justify-start items-center pt-16 px-4">
                                    ...
                                    <div className="w-full mt-12 bg-card/10 backdrop-blur-xl border border-white/20 p-3.5 rounded-2xl shadow-xl z-10 flex flex-col gap-1 text-white animate-pulse">
                                ...
                                {/* Home Bar */}
                                <div className="absolute bottom-2 w-32 h-1 bg-card/60 rounded-full z-30" />
                            </div>
                        </div>
                    </div>
                </TabsContent>
                ...
                <TabsContent value="logs" className="space-y-6">
                    <Card className="border-[#4a3728]/10 dark:border-primary/10 shadow-sm bg-card/60 backdrop-blur-md">
                        <CardHeader className="flex flex-col sm:flex-row sm:items-center sm:justify-between pb-4 border-b border-[#4a3728]/10 dark:border-primary/10 gap-4">
                            <div>
                                <CardTitle className="text-[#4a3728] dark:text-foreground flex items-center gap-2">
                            ...
                            <div className="flex flex-wrap items-center gap-3">
                                ...
                                <select
                                    ...
                                    className="h-9 rounded-lg border border-input bg-card px-2.5 py-1 text-xs ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed"
                                >
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="h-9 w-40 pl-8 text-xs bg-card"
                                    />
                                    {filterUserId !== "" && (
                                        <button
                        ...
                        <CardContent className="pt-6">
                            ...
                            {isLoadingLogs ? (
                                <div className="flex flex-col items-center justify-center py-20 text-muted-foreground">
                                    <Loader2 className="w-8 h-8 animate-spin text-[#4a3728] dark:text-foreground mb-2" />
                                ...
                                <div className="space-y-4">
                                    <div className="overflow-x-auto border border-border/80 rounded-xl bg-card/70">
                                        <table className="w-full text-left border-collapse text-sm">
                                            <thead>
                                                <tr className="bg-[#4a3728]/5 dark:bg-primary/5 border-b border-border/80 text-muted-foreground font-semibold text-xs tracking-wider uppercase">
                                            ...
                                            <tbody className="divide-y divide-border/60">
                                                {logs.map((item, index) => {
                                                    ...
                                                    return (
                                                        <tr key={item.id} className={`hover:bg-[#4a3728]/5 dark:bg-primary/5 transition-colors duration-200 ${isChecked ? "bg-[#4a3728]/5 dark:bg-primary/5" : ""}`}>
                                                            ...
                                                            <td className="p-4">
                                                                <div className="flex flex-col gap-0.5">
                                                                    <div className="flex items-center gap-1.5">
                                                                        <User className="w-3.5 h-3.5 text-[#4a3728] dark:text-foreground shrink-0" />
                                                                        <span className="text-xs font-bold text-[#4a3728] dark:text-foreground">
                                                                            {item.userDisplayName || `User ${item.userInternalId}`}
                                                                        </span>
                                                                    </div>
                                                                    <div className="text-[10px] text-muted-foreground font-mono flex items-center gap-1 opacity-70">
                                                                        ID: {item.userGuid ? `${item.userGuid.slice(0, 8)}...` : item.userInternalId}
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td className="p-4">
                                                                <div className="space-y-0.5 text-left max-w-lg">
                                                                    <p className="font-bold  dark:text-foreground line-clamp-1">{item.title}</p>
                                                                    <p className="text-xs text-muted-foreground line-clamp-2">{item.body}</p>
                                                                    {item.referenceType && (
                                                                        <div className="pt-1 flex items-center gap-1 text-[10px] font-bold  dark:text-amber-400">
                                                            ...
                                                            <td className="p-4 text-center">
                                                                <Button
                                                                    ...
                                                                    className=" dark:text-red-400 hover: dark:text-red-400 hover: dark:bg-red-500/10 rounded-lg"
                ...
                <TabsContent value="surveys" className="space-y-6 animate-in fade-in duration-300">
                            ...
                            <Card className="border-[#4a3728]/10 dark:border-primary/10 shadow-sm overflow-hidden bg-card/60 backdrop-blur-md">
                                ...
                                <CardContent className="pt-6 space-y-4">
                                    <form onSubmit={handleCreateSurveySubmit} className="space-y-4">
                                                ...
                                                <button
                                                    ...
                                                    className={`flex items-center justify-center gap-2 p-2.5 rounded-xl border text-xs font-semibold transition-all duration-300
                                                        ${surveyTargetType === "broadcast"
                                                            ? "bg-[#4a3728] dark:bg-primary text-white dark:text-primary-foreground border-transparent shadow-sm"
                                                            : "bg-card hover:bg-muted border-border/80 text-muted-foreground"}`}
                                                >
                                        ...
                                        {surveyTargetType === "targeted" && (
                                            <div className="space-y-2 p-3 bg-[#4a3728]/5 dark:bg-primary/5 border border-[#4a3728]/10 dark:border-primary/10 rounded-xl relative">
                                                <label className="text-xs font-semibold text-[#4a3728]/80 dark:text-foreground uppercase tracking-wide flex items-center gap-1.5">
                                                    Tìm kiếm người nhận <span className="text-destructive">*</span>
                                                </label>
                                                {surveySelectedUser ? (
                                                    <div className="flex items-center justify-between bg-card p-2 rounded-lg border  dark:border-green-500/20 text-xs">
                                                        <div className="flex items-center gap-2">
                                                            <div className="w-7 h-7 rounded-full bg-[#4a3728] dark:bg-primary text-white dark:text-primary-foreground flex items-center justify-center font-bold text-xs shrink-0">
                                                                {surveySelectedUser.displayName.slice(0, 2).toUpperCase()}
                                                            </div>
                                                            <div>
                                                                <p className="font-semibold text-[#4a3728] dark:text-foreground">{surveySelectedUser.displayName}</p>
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        {isSearchingSurveyUsers && (
                                                            <Loader2 className="absolute right-2.5 top-2.5 w-3.5 h-3.5 animate-spin text-[#4a3728] dark:text-foreground" />
                                                        )}
                                                        {surveySearchedUsers.length > 0 && (
                                                            <div className="absolute left-0 right-0 mt-1.5 bg-card border rounded-xl shadow-xl z-20 max-h-40 overflow-y-auto divide-y divide-border/60">
                                                                {surveySearchedUsers.map(u => (
                                                                    <button
                                                                        key={u.userId}
                                                                        type="button"
                                                                        onClick={() => setSurveySelectedUser(u)}
                                                                        className="w-full flex items-center gap-2 p-2.5 text-left hover:bg-[#4a3728]/5 dark:bg-primary/5 text-xs transition-colors duration-200"
                                                                    >
                                                                        <div className="w-6 h-6 rounded-full bg-[#4a3728]/10 dark:bg-primary/10 text-[#4a3728] dark:text-foreground flex items-center justify-center font-bold text-[10px] shrink-0">
                                                                            {u.displayName.slice(0, 2).toUpperCase()}
                                                                        </div>
                                                                        <div>
                                                                            <p className="font-semibold text-[#4a3728] dark:text-foreground">{u.displayName}</p>
                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <select
                                                ...
                                                className="w-full flex h-10 rounded-xl border border-input bg-card px-3 py-2 text-sm focus-visible:outline-none"
                                            >
                                        ...
                                        {surveyType === "quiz" && (
                                            <div className="space-y-2.5 p-3.5 bg-[#4a3728]/5 dark:bg-primary/5 border border-[#4a3728]/10 dark:border-primary/10 rounded-xl animate-in slide-in-from-top-2 duration-300">
                                                <div className="flex items-center justify-between">
                                                    <label className="text-xs font-bold text-[#4a3728]/85 dark:text-foreground uppercase tracking-wide">
                                                    ...
                                                    <Button
                                                        ...
                                                        className="h-7 text-[10px] px-2.5 rounded-lg border-[#4a3728]/20 dark:border-primary/20 text-[#4a3728] dark:text-foreground hover:bg-[#4a3728]/5 dark:bg-primary/5"
                                                    >
                                                        + Thêm đáp án
                                                    </Button>
                                                </div>
                                                <div className="space-y-2 max-h-[180px] overflow-y-auto pr-1">
                                                    {quizOptions.map((option, index) => (
                                                        <div key={index} className="flex items-center gap-2">
                                                            <span className="w-6 h-6 rounded-full bg-[#4a3728]/15 dark:bg-primary/15 text-[#4a3728] dark:text-foreground font-bold text-xs flex items-center justify-center shrink-0">
                                                            ...
                                                            {quizOptions.length > 2 && (
                                                                <Button
                                                                    ...
                                                                    className="h-8 w-8 text-rose-500 hover: dark:text-red-400 hover: dark:bg-red-500/10 rounded-lg shrink-0"
                                                                >
                                                                    <X className="w-3.5 h-3.5" />
                                                                </Button>
                                                            )}
                                        ...
                                        <Button
                                            ...
                                            className="w-full bg-[#4a3728] dark:bg-primary hover:bg-[#3d2d21] dark:hover:bg-primary/90 text-white dark:text-primary-foreground flex items-center justify-center gap-2 h-10 rounded-xl font-semibold"
                                        >
                                            {isCreatingSurvey ? (
                                                <>
                            ...
                            <div className="w-[300px] h-[580px] bg-slate-900 border-[8px] border-slate-800 rounded-[3rem] shadow-2xl relative overflow-hidden flex flex-col items-center">
                                ...
                                <div className="absolute inset-0 bg-gradient-to-b from-[#6b5847] via-[#9c8470] to-[#bca693] z-0 flex flex-col justify-start items-center pt-14 px-4">
                                    ...
                                    <div className="w-full flex justify-between items-center text-white/95 text-[9px] font-medium px-2.5 mb-8 z-10 select-none">
                                        <span>12:30</span>
                                        <div className="flex items-center gap-1">
                                            <span className="w-3 h-2 border border-white/80 rounded-sm relative flex items-center p-0.5"><span className="h-full bg-card w-2/3 rounded-xs" /></span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="w-full bg-[#f9f6f0] border border-white/20 rounded-2xl shadow-2xl flex-1 flex flex-col p-4 mb-14 relative z-10 select-none overflow-hidden max-h-[440px]">
                                        {/* App Header Mock */}
                                        <div className="w-full flex items-center justify-between text-[10px] font-bold text-[#4a3728] dark:text-foreground border-b pb-2 mb-3 opacity-75">
                                            <span>V-CLOSET TRY-ON</span>
                                            <X className="w-3 h-3 cursor-pointer text-[#4a3728] dark:text-foreground" />
                                        </div>

                                        {/* Survey Popup Modal content */}
                                        <div className="flex-1 flex flex-col justify-center items-center py-1.5 space-y-3.5">
                                            <div className="text-center space-y-1">
                                                <div className="w-9 h-9 rounded-full  dark:bg-amber-500/10 flex items-center justify-center mx-auto shadow-sm">
                                                    <Star className="w-4.5 h-4.5 text-amber-500 fill-amber-500" />
                                                </div>
                                                <h5 className="text-[10px] font-bold text-[#4a3728] dark:text-foreground leading-tight break-words max-h-[30px] overflow-hidden px-0.5">
                                                    {surveyTitle.trim() || "Tiêu đề khảo sát mẫu"}
                                                </h5>
                                                <p className="text-[9px] text-stone-600 dark:text-stone-400 font-medium break-words max-h-[45px] overflow-y-auto px-0.5 leading-normal">
                                            ...
                                            {(surveyType === "stars_only" || surveyType === "stars_and_comment") && (
                                                <div className="flex justify-center gap-1.5 py-1.5 w-full border-y border-dashed border-stone-200 dark:border-border">
                                            ...
                                            {surveyType === "quiz" && (
                                                <div className="w-full border-y border-dashed border-stone-200 dark:border-border py-1.5 max-h-[130px] overflow-y-auto space-y-1.5">
                                                    {quizOptions.map((opt, i) => (
                                                        <div key={i} className="flex items-center gap-2 p-1.5 rounded-lg border border-stone-200 dark:border-border bg-card hover:border-[#4a3728] dark:border-primary cursor-pointer transition-all text-[8px] text-[#4a3728] dark:text-foreground font-bold">
                                                            <span className="w-3.5 h-3.5 rounded-full bg-[#4a3728]/10 dark:bg-primary/10 text-[#4a3728] dark:text-foreground flex items-center justify-center text-[7px] font-bold">
                                            ...
                                            {/* Survey Link Mock */}
                                            {surveyType === "survey_link" && (
                                                <div className="w-full border-y border-dashed border-stone-200 dark:border-border py-3 flex flex-col items-center gap-2">
                                                    <div className="flex items-center justify-center w-8 h-8 rounded-full bg-[#4a3728]/5 dark:bg-primary/5 text-[#4a3728] dark:text-foreground shadow-inner shrink-0">
                                                        <Info className="w-4 h-4" />
                                                    </div>
                                                    <p className="text-[8px] text-muted-foreground font-semibold text-center max-w-[180px] break-all leading-normal px-1">
                                                        Khảo sát ngoài: <span className="underline font-bold  dark:text-blue-400">{surveyUrl.trim() || "https://forms.gle/vcloset-survey"}</span>
                                                    </p>
                                                    <div className="w-full mt-1.5 flex items-center justify-center gap-1.5 p-2 rounded-xl border border-[#4a3728]/10 dark:border-primary/10 bg-card hover:bg-[#4a3728]/5 dark:bg-primary/5 text-[8px] text-[#4a3728] dark:text-foreground font-bold select-none cursor-pointer transition-all">
                                            ...
                                            {(surveyType === "comment_only" || surveyType === "stars_and_comment") && (
                                                <div className="w-full bg-card border border-stone-200 dark:border-border rounded-lg p-2 text-[8px] text-stone-400 text-left min-h-[50px] leading-relaxed shadow-inner">
                                                    Nhập ý kiến đóng góp của bạn...
                                                </div>
                                            )}

                                            <div className="w-full flex gap-2 pt-1.5 mt-auto">
                                                <button type="button" className="flex-1 text-[8px] py-1.5 bg-[#4a3728] dark:bg-primary hover:bg-[#3d2d21] dark:hover:bg-primary/90 text-white dark:text-primary-foreground rounded-lg text-center font-bold shadow-sm transition-all">Gửi phản hồi</button>
                                                <button type="button" className="px-3 text-[8px] py-1.5 bg-stone-200 hover:bg-stone-300 text-stone-600 dark:text-stone-400 rounded-lg text-center font-semibold transition-all">Đóng</button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <Card className="border-[#4a3728]/10 dark:border-primary/10 shadow-sm bg-card/60 backdrop-blur-md mt-6">
                        <CardHeader className="pb-3 border-b border-[#4a3728]/10 dark:border-primary/10 flex flex-row items-center justify-between">
                            <div>
                                <CardTitle className="text-[#4a3728] dark:text-foreground text-base flex items-center gap-2">
                                ...
                                <div className="space-y-4">
                                    <div className="overflow-x-auto border border-border/80 rounded-xl bg-card/70">
                                        <table className="w-full text-left border-collapse text-xs">
                                            <thead>
                                                <tr className="bg-[#4a3728]/5 dark:bg-primary/5 border-b border-border/80 text-muted-foreground font-semibold uppercase tracking-wider">
                                            ...
                                            <tbody className="divide-y divide-border/60">
                                                {surveys.slice((surveysPage - 1) * surveysPageSize, surveysPage * surveysPageSize).map(s => {
                                                    ...
                                                    return (
                                                        <tr key={s.id} className="hover:bg-[#4a3728]/5 dark:bg-primary/5 transition-colors duration-200">
                                                            <td className="p-3">
                                                                <p className="font-bold text-[#4a3728] dark:text-foreground">{s.title}</p>
                                                                <p className="text-[10px] text-muted-foreground mt-0.5 line-clamp-1">{s.question}</p>
                                                            </td>
                                                            <td className="p-3">
                                                                <Badge variant="outline" className="text-[9px] py-0.5 capitalize border-[#4a3728]/10 dark:border-primary/10 text-[#4a3728] dark:text-foreground bg-[#4a3728]/5 dark:bg-primary/5">
                                                            ...
                                                            <td className="p-3 text-center">
                                                                <Badge className={s.status === "active" ? "bg-green-600 hover:bg-green-700 text-white" : "bg-muted/500 hover:bg-stone-600 text-white"}>
                                                                    {s.status === "active" ? "Đang mở" : "Đã đóng"}
                                                                </Badge>
                                                            </td>
                                                            <td className="p-3 text-center font-bold font-mono text-[#4a3728] dark:text-foreground">
                                                            ...
                                                            <td className="p-3">
                                                                <div className="flex items-center justify-center gap-1.5">
                                                                    <Button
                                                                        ...
                                                                        className="h-7 text-[10px] px-2.5 rounded-lg border-[#4a3728]/20 dark:border-primary/20 text-[#4a3728] dark:text-foreground hover:bg-[#4a3728]/5 dark:bg-primary/5 flex items-center gap-1"
                                                                    ...
                                                                    <Button
                                                                        ...
                                                                        className="h-7 w-7 p-0 rounded-lg  dark:text-red-400 hover: dark:bg-red-500/10"
                                                                    >
                ...
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2 text-[#4a3728] dark:text-foreground">
                            <Send className="w-5 h-5  dark:text-amber-400" /> Xác nhận gửi thông báo?
                        </DialogTitle>
                        <DialogDescription>
                    ...
                    <div className="bg-[#4a3728]/5 dark:bg-primary/5 p-4 rounded-xl border border-[#4a3728]/10 dark:border-primary/10 text-sm space-y-3">
                        <div className="grid grid-cols-3 gap-2">
                            <span className="font-semibold text-[#4a3728] dark:text-foreground text-xs uppercase">Người nhận:</span>
                            <span className="col-span-2 font-medium  dark:text-muted-foreground">
                                {targetType === "broadcast" ? "Tất cả người dùng (Broadcast)" : `${selectedUser?.displayName} (${selectedUser?.email})`}
                            </span>
                        </div>
                        <div className="grid grid-cols-3 gap-2">
                            <span className="font-semibold text-[#4a3728] dark:text-foreground text-xs uppercase">Phân loại:</span>
                            <span className="col-span-2 font-semibold  dark:text-muted-foreground">
                                {notifType}
                            </span>
                        </div>
                        <div className="grid grid-cols-3 gap-2">
                            <span className="font-semibold text-[#4a3728] dark:text-foreground text-xs uppercase">Tiêu đề:</span>
                            <span className="col-span-2 font-semibold  dark:text-foreground">
                                {title}
                            </span>
                        </div>
                        <div className="grid grid-cols-3 gap-2">
                            <span className="font-semibold text-[#4a3728] dark:text-foreground text-xs uppercase">Nội dung:</span>
                            <span className="col-span-2 text-xs  dark:text-muted-foreground break-words whitespace-pre-wrap">
                                {body}
                            </span>
                        </div>
                        {refType && (
                            <div className="grid grid-cols-3 gap-2 pt-1 border-t border-[#4a3728]/10 dark:border-primary/10">
                                <span className="font-semibold text-[#4a3728] dark:text-foreground text-xs uppercase">Liên kết:</span>
                                <span className="col-span-2 text-xs  dark:text-amber-400 font-bold">
                                    {refType} #{refId}
                                </span>
                            </div>
                        )}
                    ...
                    <DialogFooter className="gap-2 sm:gap-0">
                        ...
                        <Button
                            ...
                            disabled={isSending}
                            className="bg-[#4a3728] dark:bg-primary hover:bg-[#3d2d21] dark:hover:bg-primary/90 text-white dark:text-primary-foreground flex items-center gap-1.5"
                        >
                            {isSending ? (
                                <>
                                    <Loader2 className="w-4 h-4 animate-spin" />
                ...
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2  dark:text-red-400">
                            <Trash2 className="w-5 h-5  dark:text-red-400 animate-pulse" /> Xác nhận thu hồi thông báo?
                        </DialogTitle>
                        <DialogDescription>
            ...
            <Dialog open={bulkConfirmOpen} onOpenChange={(open) => !open && setBulkConfirmOpen(false)}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2  dark:text-red-400">
                            <Trash2 className="w-5 h-5  dark:text-red-400 animate-pulse" /> Xác nhận thu hồi hàng loạt?
                        </DialogTitle>
                        <DialogDescription>
                            Hành động này sẽ xóa cưỡng chế <strong className=" dark:text-red-400">{selectedIds.length} thông báo</strong> đã chọn khỏi cơ sở dữ liệu và hộp thư của tất cả người nhận tương ứng. Họ sẽ không còn thấy các thông báo này nữa.
                        </DialogDescription>
                    </DialogHeader>
            ...
            {selectedIds.length > 0 && (
                <div className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border border-[#4a3728]/20 dark:border-primary/20 shadow-2xl px-6 py-4 rounded-2xl flex items-center gap-6 z-40 animate-in slide-in-from-bottom-8 duration-300">
                    <span className="text-sm font-semibold  dark:text-foreground">
                        Đã chọn <strong className="text-[#4a3728] dark:text-foreground">{selectedIds.length}</strong> thông báo
                    </span>
                ...
                <DialogContent className="sm:max-w-3xl max-h-[85vh] overflow-y-auto font-poppins">
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2 text-[#4a3728] dark:text-foreground font-bold">
                            <MessageSquare className="w-5 h-5 text-[#4a3728] dark:text-foreground" /> Chi tiết đánh giá từ người dùng
                        </DialogTitle>
                        <DialogDescription className="text-xs font-semibold text-stone-600 dark:text-stone-400">
                            Khảo sát: <strong className="text-[#4a3728] dark:text-foreground">{selectedSurveyForDetails?.title}</strong>
                        </DialogDescription>
                    </DialogHeader>

                    {/* Rating filter inside details */}
                    <div className="flex items-center justify-between border-b pb-3.5 mt-2">
                        <span className="text-xs font-bold text-muted-foreground uppercase tracking-wide">Danh sách câu trả lời</span>
                        {selectedSurveyForDetails?.type !== "quiz" && (
                            <div className="flex items-center gap-1.5 text-xs">
                                <span className="font-semibold text-muted-foreground">Lọc sao:</span>
                                <select
                                    value={ratingFilter}
                                    onChange={e => setRatingFilter(Number(e.target.value))}
                                    className="h-8 rounded-lg border border-input bg-card px-2 py-0.5"
                                >
                    ...
                    <div className="space-y-4 pt-2">
                        {isLoadingResponses ? (
                            ...
                            <div className="max-h-[350px] overflow-y-auto border border-border/60 rounded-xl  dark:bg-muted/50/50">
                                <table className="w-full text-left border-collapse text-xs">
                                    {selectedSurveyForDetails?.type === "quiz" ? (
                                        <thead>
                                            <tr className="bg-muted border-b border-border/80 text-muted-foreground font-semibold uppercase">
                                    ...
                                    <tbody className="divide-y divide-border/60 bg-card">
                                        {surveyResponses.map(r => {
                                            ...
                                            return (
                                                <tr key={r.id} className="hover: dark:bg-muted/50 transition-colors">
                                                    <td className="p-3 font-semibold  dark:text-foreground">
                                                        <p>{r.userDisplayName}</p>
                                                        <span className="text-[10px] text-muted-foreground font-normal">{r.userEmail}</span>
                                                    </td>
                                                    {selectedSurveyForDetails?.type === "quiz" ? (
                                                        <td className="p-3 text-stone-700 dark:text-stone-300 font-medium">
                                                            <Badge variant="outline" className="bg-[#4a3728]/5 dark:bg-primary/5 border-[#4a3728]/20 dark:border-primary/20 text-[#4a3728] dark:text-foreground text-xs font-semibold py-1 px-2.5">
                                                        ...
                                                        <>
                                                            ...
                                                            <td className="p-3 text-stone-700 dark:text-stone-300 break-words whitespace-pre-wrap max-w-[280px]">
                    ...
                    <DialogFooter className="mt-4">
                        <Button onClick={() => setSelectedSurveyForDetails(null)} className="bg-[#4a3728] dark:bg-primary hover:bg-[#3d2d21] dark:hover:bg-primary/90 text-white dark:text-primary-foreground">
                            Đóng cửa sổ
                        </Button>
                    </DialogFooter>
                </DialogContent>
                ...
                <DialogContent className="sm:max-w-md font-poppins">
                    <DialogHeader>
                        <DialogTitle className="flex items-center gap-2  dark:text-red-400 font-bold">
                            <Trash2 className="w-5 h-5  dark:text-red-400 animate-pulse" /> Xác nhận xóa khảo sát?
                        </DialogTitle>
                        <DialogDescription>
