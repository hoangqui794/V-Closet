...
export function ClosetManagement() {
    ...
    return (
        <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 font-poppins text-foreground w-full">
            {/* Main Header */}
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-stone-200 dark:border-border/60 pb-5">
                <div>
                ...
                <TabsList className="bg-muted p-[3px] border border-stone-200 dark:border-border/60 shrink-0">
